...
<section id="main-content">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-file-text"></i> 
          Fund 101 Vouchers <!-- (
            <?php /*if(isset($adsearch)){
                        echo "<strong>Total count: " . $adsearch->num_rows . "</strong>";    
                    } else if (isset($fo_row)){
                        echo "<strong>Total count: " . $fo_row->num_rows . "</strong>";
                    } else if (isset($fo_rows)){
                        echo "<strong>Total count: " . $fo_rows->num_rows . "</strong>";
                    }*/
            ?>
          )-->
          &nbsp&nbsp&nbsp&nbsp
          Choose Fund:
            <select class="details-field6" id="fund_select" name="fund_select" onchange="location = this.value;">
                <option name="101" value="#">Fund 101</option>
        ...
        <form action="<?php $_PHP_SELF; ?>" method="POST">
            ...
            <input type="text" class="details-field5" id="input101" name="input101" size="35" placeholder="Input here..."/>
            <input type="submit" class= "buttons" name="search_fo" value="Search"/>
            <a class="cancel" href="/CaDIS/views/fund101.php?fo_select=yes">Cancel</a>
        </form>
        <!-- Modal -->
              ...
              <div class="modal-dialog">
                ...
                <form action="<?php $_PHP_SELF; ?>" method="POST">
                  ...
                  <div class="modal-footer">
                    <input type="hidden" name="fund" value="101"/>
        ...
        <?php if(isset($_POST['search_fo'])){ ?>
        <?php if(isset($fo_row) && $fo_row->num_rows>0){ ?>
            <div class= "div-div">
            ...
            <tbody>
            <?php foreach($fo_row as $index => $value): ?>
                <tr>
                    ...
                    <?php if($value['status']=="for_issuance"){ ?>
                        ...
                        <?php if(($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2") || $_SESSION['usertype']=="Claim/OR officer"){ ?>
                            <form action="tagvc.php?v_select=yes" method="POST" style="display:inline;margin:0px;padding:0px;">
                                ...
                                <input type="hidden" name="previous" value="fund101.php?fo_select=yes"/>
        ...
        <?php if( isset($_SESSION['usertype']) && !isset($_POST['search_fo']) && !isset($_POST['adsearch']) && $_SESSION['usertype']!="AA"){ ?>
        <?php if(isset($fo_rows) && $fo_rows->num_rows>0){ ?>
            <div class= "div-div">
            <table class="table-acct">
            <thead style="background-color:#2c3531">
            ...
            <table class="table-acct" id="item_table">
            <tbody>
            <?php foreach($fo_rows as $index => $value): ?>
                <tr>
                <?php $v_num = $value['v_num']; ?>
            ...
            <thead style="background-color:#2c3531">
                ...
                <tr>   
                    ...
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        ...
                        <th>Program</th>
                        <th style="border-top-remarks-radius:15px;">Remarks</th>
  ...
  <script type="text/javascript">
        document.getElementById('input101').value = "<?php echo $_POST['input101'];?>";
  </script>
  <script type="text/javascript">
  ...
  <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        ...
        $(function() {
            ...
            //autocomplete
            $("#input101").autocomplete({
                source: "../controllers/101_search.php",
                minLength: 1
            });                
...
<?php if(isset($fo_row) && ($fo_row->num_rows<=3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
    ...
    <?php } ?>
    <?php if(isset($fo_rows) && ($fo_rows->num_rows<=3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
