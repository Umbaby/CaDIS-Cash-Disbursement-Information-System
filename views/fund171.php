...
<section id="main-content">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-file-text"></i> 
          ...
          Choose Fund:
            <select class="details-field6" id="fund_select" name="fund_select" onchange="location = this.value;">
                <option name="171" value="#">Fund 171</option>
        ...
        <form action="<?php $_PHP_SELF; ?>" method="POST">
            ...
            <input type="text" class="details-field5" id="input171" name="input171" size="35" placeholder="Input here..."/>
            <input type="submit" class= "buttons" name="search_f171" value="Search"/>
            <a class="cancel" href="/CaDIS/views/fund171.php?f171_select=yes">Cancel</a>
        </form>
        <!-- Modal -->
              ...
              <div class="modal-dialog">
                ...
                <form action="<?php $_PHP_SELF; ?>" method="POST">
                  ...
                  <div class="modal-footer">
                    <input type="hidden" name="fund" value="171"/>
        ...
        <?php if(isset($_POST['search_f171'])){ ?>
        <?php if(isset($f171_row) && $f171_row->num_rows>0){ ?>
            <div class= "div-div">
            ...
            <tbody>
            <?php foreach($f171_row as $index => $value): ?>
                <tr>
                    ...
                    <?php if($value['status']=="for_issuance"){ ?>
                        ...
                        <?php if(($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2") || $_SESSION['usertype']=="Claim/OR officer"){ ?>
                            <form action="tagvc.php?v_select=yes" style="display:inline;margin:0px;padding:0px;" method="POST">
                                ...
                                <input type="hidden" name="previous" value="fund171.php?f171_select=yes"/>
        ...
        <?php if( isset($_SESSION['usertype']) && !isset($_POST['search_f171']) && !isset($_POST['adsearch']) && $_SESSION['usertype']!="AA"){ ?>
        <?php if(isset($f171_rows) && $f171_rows->num_rows>0){ ?>
            <div class= "div-div">
            <table class="table-acct">
            <thead style="background-color:#2c3531">
            ...
            <table class="table-acct" id="item_table">
            <tbody>
            <?php foreach($f171_rows as $index => $value): ?>
                <tr>
                <?php $v_num = $value['v_num']; ?>
  ...
  <script type="text/javascript">
        document.getElementById('input171').value = "<?php echo $_POST['input171'];?>";
  </script>
  <script type="text/javascript">
  ...
  <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        ...
        $(function() {
            ...
            //autocomplete
            $("#input171").autocomplete({
                source: "../controllers/171_search.php",
                minLength: 1
            });                
...
<?php if(isset($f171_row) && ($f171_row->num_rows<=3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
    ...
    <?php } ?>
    <?php if(isset($f171_rows) && ($f171_rows->num_rows<=3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
