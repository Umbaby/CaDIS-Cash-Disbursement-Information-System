...
<section id="main-content">
  <section class="wrapper">
        ...
        <h3 class="page-header"><i class="fa fa-file-text"></i>
          ...
          Choose Fund:
            <select class="details-field6" id="fund_select" name="fund_select" onchange="location = this.value;">
                <option name="102" value="#">Fund 102</option>
    ...
    <div class= "div-div">
        <form action="<?php $_PHP_SELF; ?>" method="POST">
            ...
            <input type="text" class="details-field5" id="input102" name="input102" size="35" placeholder="Input here..."/>
            <input type="submit" class= "buttons" name="search_ft" value="Search"/>
            <a class="cancel" href="/CaDIS/views/fund102.php?ft_select=yes">Cancel</a>
        </form>
              ...
              <div class="modal-dialog">
                ...
                <form action="<?php $_PHP_SELF; ?>" method="POST">
                  ...
                  <div class="modal-footer">
                    <input type="hidden" name="fund" value="102"/>
        ...
        <?php if(isset($_POST['search_ft'])){ ?>
        <?php if(isset($ft_row) && $ft_row->num_rows>0){ ?>
            <div class= "div-div">
            ...
            <tbody>
            <?php foreach($ft_row as $index => $value): ?>
                <tr>
                    ...
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Claim/OR officer" || ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2") || $_SESSION['usertype']== "Releasing officer")){ ?>
                        ...
                        <?php if($value['status']=="for_issuance"){ ?>
                            ...
                            <?php if(($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2") || $_SESSION['usertype']=="Claim/OR officer"){ ?>
                                <form action="tagvc.php?v_select=yes" style="display:inline;margin:0px;padding:0px;" method="POST">
                                    ...
                                    <input type="hidden" name="previous" value="fund102.php?ft_select=yes"/>
                                ...
                                <form action="<?php $_PHP_SELF; ?>" style="display:inline;margin:0px;padding:0px;" method="POST">
                                    ...
                                    <input type="hidden" name="previous" value="fund102.php?ft_select=yes"/>
                                    <input type="submit" class= "buttons" name="cancel" value="Cancel" value="Cancel" data-toggle="modal" data-target="#pop<?php echo $v_num; ?>"/>
                                </form>
                        ...
                        <?php } else if($value['status']=="claimed" && $value['payee_type'] == "creditor" && $value['payment_type'] == "ADA" && $value['date_issue']==0 && $value['or_num']=="") { ?>
                            ...
                            <form action="claimvc.php?v_select=yes" style="display:inline;margin:0px;padding:0px;" method="POST">
                                <input type="hidden" name="v_num" value="<?php echo $v_num; ?>"/>
                                <input type="hidden" name="previous" value="fund102.php?ft_select=yes"/>
                                <input type="submit" class= "buttons" name="enter_or" value="Enter OR"/>
                            </form>
        ...
        <?php if( isset($_SESSION['usertype']) && !isset($_POST['search_ft']) && !isset($_POST['adsearch']) && $_SESSION['usertype']!="AA"){ ?>
        <?php if(isset($ft_rows) && $ft_rows->num_rows>0){ ?>
            <div class= "div-div">
            <table class="table-acct">
            <thead style="background-color:#2c3531">
            ...
            <table class="table-acct" id="item_table">
            <tbody>
            <?php foreach($ft_rows as $index => $value): ?>
                <tr>
                    <?php $v_num = $value['v_num']; ?>
  ...
  <script type="text/javascript">
        document.getElementById('input102').value = "<?php echo $_POST['input102'];?>";
  </script>
  <script type="text/javascript">
  ...
  <script type="text/javascript" src="js/jquery-1.9.1.min.js"></script>
        ...
        $(function() {
            ...
            //autocomplete
            $("#input102").autocomplete({
                source: "../controllers/102_search.php",
                minLength: 1
            });                
...
<?php if(isset($ft_row) && ($ft_row->num_rows<=3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
    ...
    <?php } ?>
    <?php if(isset($ft_rows) && ($ft_rows->num_rows<=3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
