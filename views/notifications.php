...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-bell"></i>
          Notifications
        </h3> <!-- name of user -->
    ...
    <table class="table-acct">
        <thead style="background-color:#2c3531">
            <tr>
                <th style="border-top-left-radius:15px;width:150px">Notification Date</th>
                <th style="width:150px">Payee</th>
                <th style="width:150px">Reason</th>
                <th style="width:150px">Date of Expiration</th>
                <th style="width:80px">Remaining Days</th>
                <th style="border-top-right-radius:15px;width:150px">ADA/Cheque Number Reference</th>
            </tr>
        </thead>
        </table>
        </div>
        ...
        <tbody>
        <?php if(isset($nrows) && $nrows->num_rows>0){ ?>
            <?php foreach ($nrows as $index => $value): ?> 
                <tr>
                    <?php $date = date_create($value['created_at']); ?>
                    <td style="width:150px"><?php echo date_format($date,"M-d-Y h:ia"); ?></td>
                    <td style="width:150px"><strong><?php echo $value['payee']; ?></strong></td>
                    <td style="width:150px"><strong><?php echo $value['notif_detail']; ?></strong></td>
                    <td style="width:150px"><strong><?php if($value['expire_date']>0){ $date=date_create($value['expire_date']); echo date_format($date,"M-d-Y");; } else { echo ""; } ?></strong></td>
                    <td style="width:80px"><strong><?php if($value['days_left']>0){ echo $value['days_left']; } else { echo ""; }  ?></strong></td>
                    <td style="width:150px"><?php echo $value['reference']; ?></td>
                </tr>
            <?php endforeach; ?>
        <?php } else { ?>
                <tr>
...
function checkButton() {
  ...
  <<script src="js/fullcalendar.min.js"></script>
    ...
    <?php if(isset($nrows) && $nrows->num_rows<8){ ?>
        <style>
          .table-voucher2 {
            width: 100%;
          }
