...
<section id="main-content">
  <section class="wrapper">
    ...
    <div class="row">
      <div class="col-lg-12">
        <h6 class="page-header"><i class="fa fa-file-text"></i>
          Encoded Vouchers 
          
            <?php if($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2"){ ?>
                &nbsp&nbsp&nbsp&nbsp
                Choose Fund:
                <select class="details-field6" id="fund_select" name="fund_select" onchange="location = this.value;">
                    <option name="#" value="#">All Fund</option>
                    ...
                    <option name="184" value="fund184.php?f184_select=yes">Fund 101-184</option>
                </select>
        ...
        <form action="<?php $_PHP_SELF; ?>" method="POST">
            ...
            <input type="text" class="details-field5" id="input" name="input" size="35" placeholder="Input here..."/>
            <input type="submit" class= "buttons" name="search_vc" value="Search"/>
            <a class="cancel" href="/CaDIS/views/vouchers.php?vc_select=yes">Cancel</a>
            
        </form>
            <!--<a class="cancel" href="#" style="margin-left:330px" data-toggle="modal" data-target="#myModal">Advance Search</a>-->
              ...
              <div class="modal-dialog">
                ...
                <form action="<?php $_PHP_SELF; ?>" method="POST">
                  ...
                  <div class="modal-footer">
                    <input type="hidden" name="fund" value="both"/>
        ...
        <?php if(isset($_POST['search_vc']) || isset($v_row)){ ?>
        <?php if(isset($v_row) && $v_row->num_rows>0){ ?>
        <div class= "div-div">
        <table class="table-acct">
            <thead style="background-color:#2c3531">
                <tr>
                    ...
                    <?php } else if($_SESSION['usertype']=="Claim/OR officer" || $_SESSION['usertype']=="Releasing officer"){ ?>
                        <th style="border-top-left-radius:15px;text-align:left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAction</th>
                    <?php } ?>

                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th>&nbsp&nbsp&nbsp&nbsp&nbspStatus</th>
                    <?php } else if($_SESSION['usertype']=="Claim/OR officer" || $_SESSION['usertype']=="Releasing officer"){ ?>
                        <th style="text-align:left">&nbsp&nbsp&nbsp&nbspStatus</th>
                    <?php } ?>

                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype'] == "Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspDate &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspEncoded</th>
                    <?php } ?>

                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th>&nbsp&nbsp&nbsp&nbsp&nbspPayee</th>
                    <?php } else if($_SESSION['usertype']=="Claim/OR officer" || $_SESSION['usertype']=="Releasing officer"){ ?>
                        <th style="text-align:left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPayee</th>
                    <?php } ?>

                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype'] == "Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspParticular</th>
                        <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPeriod &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspFrom</th>
                        <th>Period To</th>
                        <th>Et Al</th>
                        <th>OB Number</th>
                    <?php } ?>
                    ...
                    <?php } else { ?>
                        <th>Gross Amount</th>
                        <th style="border-top-right-radius:15px;text-align:left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspNet Amount</th>
                    <?php } ?>
            ...
            <?php foreach($v_row as $index => $value): ?>
                <tr>
                    ...
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Claim/OR officer" || $_SESSION['usertype']=="Encoder" || $_SESSION['usertype'] == 'Encoder2' || $_SESSION['usertype']== "Releasing officer")){ ?>
                        ...
                        <?php if($value['status']=="for_issuance"){ ?>
                            ...
                            <?php if(($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2") || $_SESSION['usertype']=="Claim/OR officer"){ ?>
                                <form action="tagvc.php?v_select=yes" method="POST" style="display:inline;margin:0px;padding:0px;">
                                ...
                                <form action="<?php $_PHP_SELF; ?>" method="POST" style="display:inline;margin:0px;padding:0px;">
                        ...
                        <?php } else if($value['status']=="for_claim/for_or" && $value['payment_type'] == "cheque"){ ?>
                            <td style="width:4%">
                            <form action="claimvc.php?v_select=yes" method="POST" style="display:inline;margin:0px;padding:0px;">
                                <input type="hidden" name="v_num" value="<?php echo $v_num; ?>"/>
                                <input type="hidden" name="previous" value="vouchers.php?vc_select=yes"/>
                        ...
                        <?php } else if($value['status']=="for_claim/for_or" && $value['payee_type'] == "creditor" && $value['payment_type'] == "ADA" && $value['date_issue']==0 && $value['or_num']=="") { ?>
                            <td style="width:4%">
                            <form action="claimvc.php?v_select=yes" method="POST" style="display:inline;margin:0px;padding:0px;">
                                <input type="hidden" name="v_num" value="<?php echo $v_num; ?>"/>
                                <input type="hidden" name="previous" value="vouchers.php?vc_select=yes"/>
                        ...
                        <?php } else { ?>   
                            ...
                            <td style="width:4%">
                                <form style="display:inline;margin:0px;padding:0px;">
                                    <button type="button" class= "buttons" disabled>Done</button>
                                    <input type="submit" class= "buttons" name="cancel" value="Cancel" disabled/>
                                    <button type="button" class="buttons-4" value="<?php echo $v_num; ?>">Details</button> 
                                </form>
                            </td>
                            ...
                            <td style="width:4%">
                                <form style="display:inline;margin:0px;padding:0px;">
                                    <button type="button" class= "buttons" disabled>Claim</button>
                                    <input type="submit" class= "buttons" name="cancel" value="Cancel" disabled/>
                                    <button type="button" class="buttons-4" value="<?php echo $v_num; ?>">Details</button> 
                                </form>
                            </td>
                    ...
                    <?php if($value['status'] == "for_issuance"){ ?>
                        ...
                        <form action="editvoucher.php?v_select=yes" method="POST" style="display:inline;margin:0px;padding:0px;">
                                <input type="hidden" name="v_num" value="<?php echo $v_num; ?>"/>
                                <input type="hidden" name="previous" value="vouchers.php?vc_select=yes"/>
                    ...
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype'] == 'Encoder2' || $_SESSION['usertype'] == "Encoder")){ ?>
                    ...
                    <span class="hide" id="warrant_num<?php echo $value['v_num']; ?>"><?php echo $value['warrant_num']; ?></span>
        ...
        <?php } else { ?>
            <div class= "slideshow-div">
                  <img class= "slides-img" src= "img/no_search_results.png" style="width:50vh;height:50vh">
              </div>
            <h4 class= "alert2">No item/s match your search</h4>
        <?php } } ?>
        
        <?php if( (isset($_SESSION['usertype'])) && !isset($v_row) && !isset($_POST['search_vc']) && !isset($_POST['adsearch']) && ($_SESSION['usertype'] != "AA")){ ?>
        <?php if(isset($vrows) && $vrows->num_rows>0){ ?>
            <div class= "div-div">
            <table class="table-acct">
            <thead style="background-color:#2c3531">
                ...
                <tr>   
                    ...
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPayee</th>
                    <?php } else if($_SESSION['usertype']=="Claim/OR officer" || $_SESSION['usertype']=="Releasing officer"){ ?>
                        <th style="text-align:left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspPayee</th>
                    <?php } ?>
            ...
            <?php foreach($vrows as $index => $value): ?>
                <tr>
                   ...
                   <?php if($value['date_claimed']>0){ ?>
                    ...
                    <?php if($value['date_cancelled']>0){ ?>
                        <span class="hide" id="date_cancelled<?php echo $value['v_num']; ?>">
                            <?php $date=date_create($value['date_cancelled']); echo date_format($date,"M-d-Y"); } else { echo ""; } ?>
                        </span>
                    ...
                    <?php if($value['date_expire']>0){ ?>
                        <span class="hide" id="date_expire<?php echo $value['v_num']; ?>">
                            <?php $date=date_create($value['date_expire']); echo date_format($date,"M-d-Y"); } else { echo ""; } ?>
                        </span>
                </tr>
            <?php endforeach; ?>
            </tbody>
        ...
        <?php if( isset($_SESSION['usertype']) && !isset($v_row) && isset($_POST['adsearch']) ){ ?>
            ...
            <thead style="background-color:#2c3531">
                <tr>
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th style="border-top-left-radius:15px;">&nbsp&nbsp&nbsp&nbsp&nbspAction</th>
                    <?php } else if($_SESSION['usertype']=="Claim/OR officer" || $_SESSION['usertype']=="Releasing officer"){ ?>
                        <th style="border-top-left-radius:15px;text-align:left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspAction</th>
                    <?php } ?>
                    ...
                    <?php if(isset($_SESSION['usertype']) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
                        <th>Gross Amount</th>
                    <?php } else { ?>
                        <th style="border-top-right-radius:15px;text-align:left">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspGross Amount</th>
                    <?php } ?>
  ...
  <script type="text/javascript">
    ...
    <?php } ?>
    <?php if(isset($v_row) && ($v_row->num_rows<3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
    ...
    <?php } ?>
    <?php if(isset($vrows) && ($vrows->num_rows<3) && ($_SESSION['usertype']=="Encoder" || $_SESSION['usertype']=="Encoder2")){ ?>
        <style>
        .table-voucher2 {
            width: 98%;
            margin-left: 0px;
    ...
    <?php } ?>
    <?php if(($_POST['input_status'] == 'cancelled' || $_POST['input_status'] == 'expired') && ($_SESSION['usertype']!="Encoder" && $_SESSION['usertype']!="Encoder2")){ ?>
        <style>
            .table-voucher2 {
            width: 80%;
            margin: auto;
