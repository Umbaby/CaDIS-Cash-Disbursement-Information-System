        ...
        <table class="table-acct">
            ...
            <?php foreach($v_row as $index => $value): ?>
                <tr>
                    ...
                    <td><input type="text" class="details-field3" id="payee" name="payee" size="50px" value="<?php echo $value['payee']; ?>" readonly/></td>
                    <td><input type="text" class="details-field4" id="gross" name="gross" min="0" max="<?php echo $value['gross']; ?>" style="width:150px" value="<?php echo number_format($value['gross'],2,'.',','); ?>" readonly/></td>
        ...
        <table class="table-acct" id="item_table">
            ...
            <?php foreach($v_row as $index => $value): ?>
                ...
                <tr>
                    ...
                    <td><input type="text" class="details-field3" id="payee2" name="payee[]" size="50px" value="<?php echo $value['payee']; ?>" required/></td>
                    <td><input onkeyup = "javascript:this.value=Comma(this.value);" onblur="findTotal()" type="text" class="details-field4" id="gross2" name="gross[]" min="0" style="width:150px" placeholder="Input here..." step=".01" required/></td>
                ...
                <tr> 
                    <td><input type="number" class="details-field4" id="warrant2" name="warrant[]" placeholder="Input here..." required/></td>
                    <td><input type="text" class="details-field3" id="payee2" name="payee[]" size="50px" value="<?php echo $value['payee']; ?>" required/></td>
                    <td><input onkeyup = "javascript:this.value=Comma(this.value);" onblur="findTotal()" type="text" class="details-field4" id="gross3" name="gross[]" min="0" style="width:150px" placeholder="Input here..." step=".01" required/></td>
                    <td><button type="button" name="remove" style="width:80px" class="btn btn-danger btn-sm remove"><span class="glyphicon glyphicon-minus"></span></button></td>
                </tr>
            <?php endforeach; ?>
            </tbody>
                <tr>
                    ...
                    <td>Date Released<br><input type="date" class="details-field4" id="date_released2" name="date_released" required/></td>
...
$(document).ready(function(){
 ...
 $(document).on('click', '.add', function(){
  ...
  html += '<td><input type="text" name="payee[]" size="50px" class="details-field3 payee" value="<?php echo $value['payee']; ?>"/></td>';
  html += '<td><input onkeyup = "javascript:this.value=Comma(this.value);" onblur="findTotal()" type="text" name="gross[]" min="0" style="width:150px" class="details-field4 gross" step=".01" placeholder="Input here..." required/></td>';
...
<script>
function myFunction() {
    if($('#warrant').val() == '' || ($('#date_released').val() == null) || $('#payee').val() == '' || ($('#gross').val() == null)){
...
function myFunction2() {
    if($('#warrant2').val() == '' || ($('#date_released2').val() == null) || $('#payee2').val() == '' || ($('#gross2').val() == null)){
        alert("Some information are missing.");
    } else {
        alert("The voucher was successfully tagged.");
    }
